...
color09="e0/a0/ae" # Base 08 - Bright Red
color10="d6/d0/98" # Base 0B - Bright Green
color11="fb/e7/d5" # Base 0A - Bright Yellow
color12="be/d5/d6" # Base 0D - Bright Blue
color13="d3/cd/dc" # Base 0E - Bright Magenta
color14="b4/d9/cb" # Base 0C - Bright Cyan
